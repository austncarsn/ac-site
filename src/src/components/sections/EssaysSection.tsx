...
const ESSAYS: Essay[] = [
  {
    ...
    category: 'Process',
    excerpt: 'Today I woke up and chose chaos, again, but with taste. The plan was simple. Open the laptop, calmly refine a few components, ship a clean update to the portfolio, and feel like a functioning adult. Instead I accidentally ran a full scale creative heist on my own focus. This is how I work. I do not walk in a straight line toward a goal. I ricochet. My chaos is not an accident. It is a process with bad posture.',
    content: [
      'Today I woke up and chose chaos, again, but with taste.',
      'The plan was simple. Open the laptop, calmly refine a few components, ship a clean update to the portfolio, and feel like a functioning adult. Instead I accidentally ran a full scale creative heist on my own focus. One moment I was adjusting letter spacing on a hero title, the next I had six new project ideas, three Figma files, two design systems, and a half written prompt for a future AI agent who does not even exist yet.',
      ...
      'This is how I work. I do not walk in a straight line toward a goal. I ricochet.',
      ...
      'My chaos is not an accident. It is a process with bad posture.',
